...
<div
  class="moveable-block block-{i++} top-20 left-[-10vw] !w-[20rem] !h-[10rem] translate-x-[-80px] opacity-0"
>
  <img
...
<div
  class="moveable-block block-{i++} top-[60vh] left-[14vw] !w-[18rem] !h-[10rem] translate-x-[-100px] opacity-0"
>
  <img
...
<div
  class="moveable-block block-{i++} top-[80vh] right-[15vw] !w-[18rem] !h-[20rem] translate-x-[80px] opacity-0"
>
  <img
...
<div
  class="moveable-block block-{i++} top-28 right-[-4vw] !w-[18rem] !h-[15rem] translate-x-[100px] opacity-0"
>
  <img
...
<style lang="postcss">
  div {
    @apply hidden lg:block absolute w-80 h-60 rounded-[30px] overflow-hidden bg-dark duration-[0.01s] transition-all z-10;
    box-shadow: 0px 109px 92px rgba(0, 0, 0, 0.09),
