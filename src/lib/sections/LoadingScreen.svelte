...
<section
  ...
  class="bg-white fixed inset-0 w-full h-full flex items-center justify-center z-50"
>
  {#if $loadingUpload}
    <LoadingBar />
  {:else}
    <div class="container bg-gray-100 p-3.5 w-fit rounded">
      <svg
        width="18"
        viewBox="0 0 16 16"
        fill="none"
        class={"stroke-gray-600 animate-spin"}
